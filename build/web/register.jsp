...
<header>
	...
	<div style="width: 600px; height: 550px; background-color: rgba(195, 195, 195, 0.8);" id="d1">
		...
		<table align="center" style="font-size: 25px;">
			<tr><td>Enter your Name:</td><td><input type="text" required name="t1" id="t1"></td></tr>
			...
			<tr><td>Contact Number:</td><td><input type="text" name="t6" id="t6"></td></tr>
                        <tr><td>Mail id:</td><td><input type="text" name="t7" id="t7"></td></tr>
                    </table><br><br>
		...
		<input type="reset" name="b1" id="b2" value="cancel" style="width:80px; height:40px; background-color:orange; border-radius:5px; border-color: orange;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
